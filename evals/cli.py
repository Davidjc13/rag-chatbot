...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m evals",
        description=(
            "Evalúa retrieval sobre rag-mini-bioasq (hit@k, recall@k, mrr). "
            "Opcional: --generate y/o --ragas para respuestas y juez LLM."
        ),
    )
    parser.add_argument(
        "--limit",
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("evals/results/bioasq"),
...
async def _async_main(args: argparse.Namespace) -> int:
    ...
    if args.import_db or args.use_db or args.force_import:
    ...
    payload: dict[str, object] = {
        ...
        "mode": "generate" if args.generate else "retrieval",
